...
//        configureApi(app)
//
//        app.router.post("*") { request -> HBResponse in
//            let incoming = request.apiGatewayV2Request
//            request.logger.customTrace(incoming)
//
//            return HBResponse(status: .ok,
//                       headers: .init([("contentType", "plain/text")]),
//                       body: .data( "testing".data(using: .utf8)! ))
//        }
//    }
//}
